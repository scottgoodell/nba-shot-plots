...
class GameShotPlot:
  ...
  def build(self):
    ...
    # 3PT Arc
    court_ax.add_artist(mpl.patches.Arc((0, 125), 430, 315, theta1=4, theta2=176, facecolor='none', edgecolor=lines_color, lw=lines_width, snap=True, alpha=lines_opacity))
